...
const normalizeRecord = (
  ...
  if (
    ...
    return {
      ...
      county: (first.county as string) || "",
      subcounty: (first.subcounty as string) || "",
      location: (first.location as string) || "",
      topicTrained: (first.topicDiscussed as string) || "",
      totalFarmers: Number(first.totalFarmers) || Number(raw.totalFarmers) || 0,
      startDate: (first.startDateISO as string) || (first.startDateLabel as string) || "",
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        />
        <StatsCard
          title="SUB COUNTIES COVERED"
          value={formatNumber(stats.totalSubCounties)}
          icon={MapPin}
          description="Sub-counties reached"
        />
      </div>
